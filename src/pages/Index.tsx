  ...
  const features = [
    ...
    },
    {
      ...
      details: [
        ...
        "Tax optimization strategies for Vietnamese and foreign investors"
      ],
      metrics: [
    ...
    },
    {
      ...
      description: "Access Vietnam's most comprehensive real estate database with over 3,000 new properties added monthly. Our system aggregates data from 50+ verified sources including developers, brokers, government records, and exclusive off-market opportunities.",
      details: [
  ...
  const testimonials = [
    {
      ...
      role: "Managing Director, Minh Investment Group",
      company: "AUM: $200M+",
      content: "The institutional-grade analysis and exclusive deal flow have been instrumental in our Ho Chi Minh City portfolio expansion. Their AI-driven insights identified opportunities that generated 22% IRR across our last three acquisitions.",
      rating: 5
    },
    {
      name: "Sarah Thompson", 
      role: "Head of Real Estate, Pacific Capital",
      company: "International Investment Fund",
      content: "Professional service that matches our institutional standards. The comprehensive due diligence reports and market intelligence have become essential tools for our Southeast Asia real estate investments.",
      rating: 5
    },
    {
      name: "Tran Hoang Nam",
      role: "Senior Partner, Nam Family Office", 
      company: "Multi-Family Office",
      content: "Exceptional market access and analytical capabilities. The team's expertise in Vietnamese regulations and tax optimization strategies has added significant value to our real estate allocation strategy.",
      rating: 5
    }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={heroImage}
            alt="Ho Chi Minh City Real Estate Investment"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          <div className="mb-4 inline-block bg-emerald-800 px-4 py-2 text-xs font-semibold uppercase tracking-wide">
          ...
          <p className="text-lg md:text-xl mb-6 max-w-3xl mx-auto leading-relaxed opacity-90">
            ...
            investment analysis trusted by family offices and investment funds across Southeast Asia.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
            ...
            <Button 
              ...
              className="bg-emerald-700 hover:bg-emerald-600 text-white px-6 py-3 text-sm font-semibold h-12 transition-colors"
            >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center bg-white p-6 border border-gray-200">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-emerald-800 mb-3">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">
              Professional Investment Solutions for
              <span className="block text-emerald-800 mt-2">Institutional Clients</span>
            </h2>
            <p className="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Our agency provides institutional-grade real estate intelligence and investment solutions 
              trusted by family offices, investment funds, and high-net-worth individuals across Southeast Asia.
            </p>
          </div>
                ...
                <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-12 h-12 bg-emerald-800 flex items-center justify-center">
                        <feature.icon className="w-6 h-6 text-white" />
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-1">{feature.title}</h3>
                        <p className="text-sm font-semibold text-emerald-800 uppercase tracking-wide">{feature.subtitle}</p>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-2">
                      {feature.details.map((detail, idx) => (
                        <li key={idx} className="flex items-start gap-3">
                          <div className="w-1.5 h-1.5 bg-emerald-800 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {feature.metrics.map((metric, idx) => (
                      <div key={idx} className="text-center border border-gray-200 py-4 px-2">
                        <div className="text-2xl font-bold text-emerald-800">{metric.value}</div>
                  ...
                  <div className="pt-4">
                    <Button 
                      variant="outline" 
                      className="border-emerald-800 text-emerald-800 hover:bg-emerald-800 hover:text-white px-6 py-2 h-10 font-semibold transition-colors"
                    >
          ...
          <div className="mt-16 bg-gray-900 text-white p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 max-w-3xl mx-auto">
                ...
                family offices, and institutional investors throughout Southeast Asia and beyond.
              </p>
            </div>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-3xl font-bold text-amber-400">$1.5B+</div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-base text-gray-700 max-w-3xl mx-auto">
              ...
              seeking sophisticated real estate investment solutions in the Vietnamese market.
            </p>
          </div>
            ...
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-white p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4 mb-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-emerald-800 flex items-center justify-center">
                    <benefit.icon className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-1">{benefit.title}</h3>
                    <p className="text-sm font-semibold text-emerald-800 uppercase tracking-wide">{benefit.subtitle}</p>
                  </div>
                </div>
                ...
                <ul className="space-y-1">
                  {benefit.keyPoints.map((point, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <div className="w-1 h-1 bg-emerald-800 mt-2 flex-shrink-0"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-base text-gray-700 max-w-3xl mx-auto">
              ...
              for their Southeast Asia real estate investment strategies.
            </p>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white p-6 border border-gray-200">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="text-xs text-emerald-800 font-medium">{testimonial.company}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
              <Button 
                onClick={handleRegister}
                className="bg-emerald-700 hover:bg-emerald-600 text-white px-8 py-3 text-sm font-semibold h-12 transition-colors"
              >
