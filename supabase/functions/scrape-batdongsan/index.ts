...
// Parse property data with AI (OpenAI)
...
- Формат: "[Тип] [Комнаты]-комн. в [Район на русском]"
- Для количества комнат используй формат "X-комн." (НЕ "ПН"!):
  - 1 спальня = 1-комн.
  - 2 спальни = 2-комн.
  - 3 спальни = 3-комн.
  - Студия остаётся "Студия"
...
- Примеры: "Квартира 2-комн. в Район 7", "Студия в Бинь Тхань", "Апартаменты 3-комн. в Тхао Дьен"

Для поля location_area тоже переводи на русский!

Поля для извлечения:
- title: Короткий русский заголовок (см. формат выше, используй X-комн., НЕ ПН!)
